...
export const ServerMember: FC<ServerMemberProps> = ({ member, server }) => {
  ...
  return (
    <button
      className={cn(
        'group px-2 py-2 rounded-md items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1',
    ...
    >
      ...
      <p
        className={cn(
          ...
          params?.channeldId === member.id && 'text-primary dark:text-zinc-200 dark:group-hover:text-white'
        )}
      >
        {member.user.name}
      </p>
